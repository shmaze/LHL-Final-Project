...
#     ax1.set_yticklabels(range(0, total_predictions, 1), fontsize=20)
    ...
    ax3.hlines(y=0, xmin=quant_data.index[0], xmax=quant_data.index[-1], color='red', linestyles='--')
    ...
    ax4.hlines(y=0, xmin=quant_data.index[0], xmax=quant_data.index[-1], color='red', linestyles='--')
    ...
    ax5.hlines(y=1000, xmin=quant_data.index[0], xmax=quant_data.index[-1], color='red', linestyles='--')
